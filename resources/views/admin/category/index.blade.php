            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        @endif
                        <h3 class="box-title">Control categories</h3>
                            <a href="{{url('/adminpanel/category/create')}}" class="btn btn-primary pull-right ladda-button"><i class="glyphicon glyphicon-plus"></i> Add category</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
@section('footer')
    ...
    <script type ="text/javascript">
        ...
        var table = $('#data').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ url('/adminpanel/category/data') }}',
            columns: [
                {data: 'id', name: 'id'},
                {data: 'name', name: 'name'},
